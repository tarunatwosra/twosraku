...
classes: academic_year_id, major_id
...
1. Core tables first (academic_years, majors, users, roles, permissions)
...
- `database/migrations/003_remove_grades.sql` - Hapus grade_id dari classes
