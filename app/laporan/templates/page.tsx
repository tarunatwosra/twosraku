    ...
    <AppShell title="Template Laporan" description="Kelola template laporan">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="p-4">
            <p className="text-sm text-[var(--text-muted)]">Total Penggunaan</p>
            <p className="text-2xl font-bold text-[var(--primary)]">{stats.totalUsage}x</p>
          </Card>
          <Card className="p-4">
            <p className="text-sm text-[var(--text-muted)]">Total Download</p>
            <p className="text-2xl font-bold text-[var(--info)]">{stats.totalDownloads}</p>
          </Card>
        </div>
